...
- Method main() ada di file SmartRoom
- Lihat semua class dan pahami fungsinya.
- Deklarasi method yang telah disediakan tidak boleh diubah
- Boleh buat method baru sesuai kebutuhan
- Buatlah logic dari method baru atau method yang masih belum memiliki logic
- Setelah selesai mengerjakan buat folder dengan nama file: quiz1-pbo-cs-nim
  di file sharing dan simpan semua file .java yang telah dikerjakan di file tersebut

Aturan pengerjaan file SamrtRoom.java
...
public class SmartRoom {
    ...
    public static void main( String args[]){
        ...
        //buat 2 buah obejk LampuUtama dan Lampu Tidur dengan
        ...
        myroom.readTime(8);             //Saat pergi beraktifitas outdoor
